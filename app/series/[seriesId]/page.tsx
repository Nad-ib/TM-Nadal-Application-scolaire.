...
export default function BranchDetailPage() {
    ...
    const notes = [
        ...
        { id: "2", title: "Série de tests - Élec", note: 4.5, weight: 0.25, date: "29 Oct" },
        { id: "3", title: "TP n°3-Optique", note: 5.5, weight: 0.5, date: "12 Nov" },
        { id: "4", title: "Série de tests - Élec", note: 4.5, weight: 0.25, date: "29 Oct" },
    ];
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="fixed bottom-8 right-8 z-50">
                ...
                <AddButton 
                    branchId="temp-id" 
                    onNoteAdded={() => console.log("Note ajoutée")} 
                />
            </div>
        </div>
    );
