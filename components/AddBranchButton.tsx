	...
	return (
		<>
			<button
				...
				className="w-14 h-14 bg-[#1E3A8A] rounded-full flex items-center justify-center shadow-lg text-white text-3xl">
				+
			</button>
					...
					<div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
						<motion.div
							...
							<form onSubmit={handleSubmit} className="flex flex-col gap-4">
								...
								<button
									disabled={loading}
									className="bg-[#1E3A8A] text-white font-bold py-4 rounded-2xl">
